...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1195: x0 => x0.length,
      _1268: (x0,x1) => x0.is_answer_forty_two(x1),
      _1269: (x0,x1,x2) => x0.add(x1,x2),
      _1277: Date.now,
      _1279: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1280: s => {
      ...
      _1282: () => typeof dartUseDateNowForTicks !== "undefined",
      _1283: () => 1000 * performance.now(),
      _1284: () => Date.now(),
      _1287: () => new WeakMap(),
      _1288: (map, o) => map.get(o),
      _1289: (map, o, v) => map.set(o, v),
      _1290: x0 => new WeakRef(x0),
      _1291: x0 => x0.deref(),
      _1297: () => globalThis.WeakRef,
      _1302: s => JSON.stringify(s),
      _1303: s => printToConsole(s),
      _1304: (o, p, r) => o.replaceAll(p, () => r),
      _1306: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1307: s => s.toUpperCase(),
      _1308: s => s.trim(),
      _1309: s => s.trimLeft(),
      _1310: s => s.trimRight(),
      _1311: (string, times) => string.repeat(times),
      _1312: Function.prototype.call.bind(String.prototype.indexOf),
      _1313: (s, p, i) => s.lastIndexOf(p, i),
      _1314: (string, token) => string.split(token),
      _1315: Object.is,
      _1320: a => a.pop(),
      _1321: (a, i) => a.splice(i, 1),
      _1322: (a, s) => a.join(s),
      _1323: (a, s, e) => a.slice(s, e),
      _1326: a => a.length,
      _1328: (a, i) => a[i],
      _1329: (a, i, v) => a[i] = v,
      _1331: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1332: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1333: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1334: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1335: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1336: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1337: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1338: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1340: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1341: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1342: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1343: (t, s) => t.set(s),
      _1345: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1347: o => o.buffer,
      _1348: o => o.byteOffset,
      _1349: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1350: (b, o) => new DataView(b, o),
      _1351: (b, o, l) => new DataView(b, o, l),
      _1352: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1353: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1354: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1355: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1356: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1357: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1358: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1359: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1360: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1361: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1362: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1363: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1366: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1367: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1368: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1369: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1370: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1371: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1388: o => Object.keys(o),
      _1389: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1390: (handle) => clearTimeout(handle),
      _1393: (c) =>
      ...
      _1396: (x0,x1) => x0.exec(x1),
      _1397: (x0,x1) => x0.test(x1),
      _1398: x0 => x0.pop(),
      _1400: o => o === undefined,
      _1402: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1404: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1405: o => o instanceof RegExp,
      _1406: (l, r) => l === r,
      _1407: o => o,
      _1408: o => o,
      _1409: o => o,
      ...
      _1411: o => o.length,
      _1413: (o, i) => o[i],
      _1414: f => f.dartFunction,
      _1415: () => ({}),
      _1416: () => [],
      _1418: () => globalThis,
      _1419: (constructor, args) => {
      ...
      _1421: (o, p) => o[p],
      _1422: (o, p, v) => o[p] = v,
      _1423: (o, m, a) => o[m].apply(o, a),
      _1425: o => String(o),
      _1426: (p, s, f) => p.then(s, f),
      _1427: o => {
      ...
      _1428: o => [o],
      _1429: (o0, o1) => [o0, o1],
      _1430: (o0, o1, o2) => [o0, o1, o2],
      _1431: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      _1432: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmI8ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _1433: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1440: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmF64ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _1441: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmF64ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _1442: x0 => new ArrayBuffer(x0),
      _1443: s => {
        if (/[[\]{}()*+?.\\^$|]/.test(s)) {
            s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
        }
      ...
      _1445: x0 => x0.index,
      _1447: x0 => x0.flags,
      _1448: x0 => x0.multiline,
      _1449: x0 => x0.ignoreCase,
      _1450: x0 => x0.unicode,
      _1451: x0 => x0.dotAll,
      _1452: (x0,x1) => x0.lastIndex = x1,
      _1453: (o, p) => p in o,
      _1454: (o, p) => o[p],
      _1457: x0 => x0.random(),
      _1460: () => globalThis.Math,
      _1461: Function.prototype.call.bind(Number.prototype.toString),
      _1462: Function.prototype.call.bind(BigInt.prototype.toString),
      _1463: Function.prototype.call.bind(Number.prototype.toString),
      _1464: (d, digits) => d.toFixed(digits),
      _1515: x0 => globalThis.window.flutter_wasm_interop.loadModule(x0),
      _1516: x0 => globalThis.window.flutter_wasm_interop.getModule(x0),
      _1517: () => globalThis.window.flutter_wasm_interop,
...
"assets/assets/rust_lib/pkg/rust_lib.js",
"Failed to get WASM module instance for: assets/assets/rust_lib/pkg/rust_lib.js. The module might have failed to initialize.",
"Failed to initialize WASM module from ",
"FA==",
"FQ==",
"flutter/backgesture",
"flutter/menu",
